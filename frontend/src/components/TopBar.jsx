...
const TopBar = () => {
  return (
    <div className="bg-primary-green text-white py-2 text-sm animate-fade-in">
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-2 md:gap-0 font-bold">
        <div className="flex flex-wrap justify-center gap-4 md:gap-6">
          ...
          <span className="flex items-center gap-2"><FaEnvelope /> info@mlxdirect.com</span>
        </div>
      </div>
    </div>
  );
